...
class CombatTab:
    ...
    def setup_attack_skills_section(self):
        ...
        title_attack_label = ctk.CTkLabel(master=attack_frame, text="Perícias de Ataque Base", font=ctk.CTkFont(size=16, weight="bold"))
    ...
    def setup_armor_shield_section(self):
        ...
        title_armor_label.grid(row=0, column=0, columnspan=4, padx=5, pady=(0, 5), sticky="n")
    ...
    def setup_equipped_weapons_slots_section(self):
        ...
        equipped_frame.columnconfigure(1, weight=2); equipped_frame.columnconfigure(2, weight=1); 
        equipped_frame.columnconfigure(4, weight=0); equipped_frame.columnconfigure(5, weight=0); 
        equipped_frame.columnconfigure(6, weight=0) 
        title_equipped_label = ctk.CTkLabel(master=equipped_frame, text="Armas Equipadas", font=ctk.CTkFont(size=16, weight="bold")); title_equipped_label.grid(row=0, column=0, columnspan=7, pady=(0, 5), sticky="n")
        mh_label = ctk.CTkLabel(master=equipped_frame, text="Mão Principal:"); mh_label.grid(row=1, column=0, padx=5, pady=2, sticky="w")
        self.mh_name_label = ctk.CTkLabel(master=equipped_frame, text="---", anchor="w"); self.mh_name_label.grid(row=1, column=1, padx=5, pady=2, sticky="ew")
        ...
        self.mh_damage_mod_label = ctk.CTkLabel(master=equipped_frame, text="Mod.D:"); self.mh_damage_mod_label.grid(row=1, column=3, padx=(10, 0), pady=2, sticky="w")
        self.mh_damage_mod_entry = ctk.CTkEntry(master=equipped_frame, placeholder_text="+0", width=35); self.mh_damage_mod_entry.grid(row=1, column=4, padx=(0, 5), pady=2, sticky="w")
        ...
        oh_label = ctk.CTkLabel(master=equipped_frame, text="Mão Secundária:"); oh_label.grid(row=2, column=0, padx=5, pady=2, sticky="w")
        self.oh_name_label = ctk.CTkLabel(master=equipped_frame, text="---", anchor="w"); self.oh_name_label.grid(row=2, column=1, padx=5, pady=2, sticky="ew")
        ...
        self.oh_damage_mod_label = ctk.CTkLabel(master=equipped_frame, text="Mod.D:"); self.oh_damage_mod_label.grid(row=2, column=3, padx=(10, 0), pady=2, sticky="w")
        self.oh_damage_mod_entry = ctk.CTkEntry(master=equipped_frame, placeholder_text="+0", width=35); self.oh_damage_mod_entry.grid(row=2, column=4, padx=(0, 5), pady=2, sticky="w")
    ...
    def setup_weapons_list_section(self):
        ...
        weapons_main_frame.grid(row=3, column=0, columnspan=2, padx=5, pady=5, sticky="nsew")
        weapons_main_frame.rowconfigure(1, weight=1); weapons_main_frame.columnconfigure(0, weight=1)
        title_weapons_label = ctk.CTkLabel(master=weapons_main_frame, text="Inventário de Armas", font=ctk.CTkFont(size=16, weight="bold")); title_weapons_label.pack(pady=(0, 5))
        ...
        for col, header_text in enumerate(headers):
            header_label = ctk.CTkLabel(master=self.weapons_scroll_frame, text=header_text, font=ctk.CTkFont(weight="bold")); header_label.grid(row=0, column=col, padx=2, pady=5, sticky="w")
        self.weapon_current_row_idx = 1
    ...
    def add_weapon_entry_row(self, name="", damage_dice="", atk_attr="FOR", 
        ...
        remove_button = ctk.CTkButton(master=row_frame, text="X", width=25, height=25, command=lambda rf=row_frame, rd=weapon_data_dict: self.remove_weapon_row(rf, rd))
