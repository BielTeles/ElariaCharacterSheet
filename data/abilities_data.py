...
ABILITIES_DATA = {
    "Evocador": {
        ...
        "subclasses": {
            "Caminho da Terra": { # Atributo Chave: Sabedoria
                "habilidades": [
                    {"nivel_req": 1, "nome": "Sintonia Reforçada (Terra)", "descricao": "Aumenta sua RD contra dano em 1 ponto.", "tipo": "Passiva de Caminho"}, #
                    ...
                    {"nivel_req": 1, "nome": "Abraço da Terra", "descricao": "(Ação) Área 1,5m dificulta movimento (TR Força CD Normal ou desloc. /2). Duração: 3 turnos.", "custo": "1 PM", "acao": "Ação Padrão", "alcance": "9m", "tipo": "Manifestação da Terra", "grupo_escolha": "manifestacoes_terra_lvl1", "limite_escolha": 2}, #
                    {"nivel_req": 1, "nome": "Moldar Abrigo", "descricao": "(Ação) Cria cobertura para criatura Média ou menor. Duração: 3 turnos ou até ser destruída (PV = 2xNível, RD 1).", "custo": "2 PM", "acao": "Ação Padrão", "alcance": "Toque", "tipo": "Manifestação da Terra", "grupo_escolha": "manifestacoes_terra_lvl1", "limite_escolha": 2}, #
                    {"nivel_req": 1, "nome": "Sentido Sísmico", "descricao": "Percebe automaticamente criaturas médias+ em contato com o solo a até 9m (não voadoras/leves).", "tipo": "Passiva de Caminho"}, #
                ]
            },
            "Caminho da Água": { # Atributo Chave: Sabedoria
                "habilidades": [
                    {"nivel_req": 1, "nome": "Sintonia Reforçada (Água)", "descricao": "Prende respiração por 5 min; Vantagem em Atletismo para Nadar.", "tipo": "Passiva de Caminho"}, #
                    ...
                    {"nivel_req": 1, "nome": "Sentir a Água", "descricao": "Próximo a água (3m), percebe criaturas médias+ se movendo na água a até 9m.", "tipo": "Passiva de Caminho"}, #
                ]
            },
            "Caminho do Ar": { # Atributo Chave: Inteligência
                "habilidades": [
                    {"nivel_req": 1, "nome": "Sintonia Reforçada (Ar)", "descricao": "Aumento de deslocamento base +1,5 metros.", "tipo": "Passiva de Caminho"}, #
                    ...
                    {"nivel_req": 1, "nome": "Sentir a Brisa", "descricao": "Vantagem em Percepção para notar criaturas voadoras, invisíveis (se perturbam ar) ou mudanças climáticas.", "tipo": "Passiva de Caminho"}, #
                ]
            },
            "Caminho do Fogo": { # Atributo Chave: Inteligência
                "habilidades": [
                    {"nivel_req": 1, "nome": "Sintonia Reforçada (Fogo)", "descricao": "Ganha Resistência a Fogo.", "tipo": "Passiva de Caminho"}, #
                    {"nivel_req": 1, "nome": "Combustão Controlada", "descricao": "(Ação) Explosão 1,5m raio. Alvos TR DES (CD Normal) ou 1d6 dano Fogo (metade se passar).", "custo": "2 PM", "acao": "Ação Padrão", "alcance": "9m", "duracao": "1 Turno", "tipo": "Manifestação do Piromante", "grupo_escolha": "manifestacoes_fogo_lvl1", "limite_escolha": 2}, #
                    ...
                    {"nivel_req": 1, "nome": "Coração Ardente", "descricao": "Vantagem em TR contra efeitos de Amedrontado.", "tipo": "Passiva de Caminho"}, #
                ]
            },
            "Caminho da Luz": { # Atributo Chave: Sabedoria
                "habilidades": [
                    {"nivel_req": 1, "nome": "Sintonia Reforçada (Luz)", "descricao": "Vantagem em Intuição para detectar mentiras de criaturas visíveis.", "tipo": "Passiva de Caminho"}, #
                    ...
                    {"nivel_req": 1, "nome": "Luz Reveladora", "descricao": "(Ação) Luz 1,5m raio revela invisíveis, dissipa Escuridão Mágica (CD SAB). Duração: Concentração.", "custo": "2 PM", "acao": "Ação Padrão", "alcance": "9m", "tipo": "Manifestação dos Luminantes", "grupo_escolha": "manifestacoes_luz_lvl1", "limite_escolha": 2}, #
                    ...
                    {"nivel_req": 1, "nome": "Presença Serena", "descricao": "Aliados a até 1,5m recebem Vantagem em TR vs Amedrontado.", "tipo": "Passiva de Caminho"}, #
                ]
            },
            "Caminho da Sombra": { # Atributo Chave: Inteligência
                "habilidades": [
                    {"nivel_req": 1, "nome": "Sintonia Reforçada (Sombra)", "descricao": "Vantagem em Furtividade na penumbra.", "tipo": "Passiva de Caminho"}, #
                    ...
                    {"nivel_req": 1, "nome": "Mente Quieta", "descricao": "Vantagem em TR contra leitura de pensamentos ou detecção de emoções.", "tipo": "Passiva de Caminho"}, #
                ]
            }
        }
    },
    "Titã": {
        ...
        "base": [
            {"nivel_req": 1, "nome": "Força Titânica", "descricao": "Adiciona FOR novamente ao dano corpo a corpo (armas de 2 mãos ou que usam FOR).", "tipo": "Passiva de Classe"}, #
        ...
        "subclasses": {
            "Baluarte": {
                "habilidades": [
                    {"nivel_req": 1, "nome": "Presença Protetora", "descricao": "Aliados adjacentes +1 RD contra ataques corpo a corpo.", "tipo": "Passiva de Arquétipo"}, #
            ...
            "Fúria Primal": {
                "habilidades": [
                    {"nivel_req": 1, "nome": "Ímpeto Selvagem", "descricao": "Com PV <= Metade, desloc. +1,5m no turno. Ao zerar PV inimigo, recupera 2 Vigor.", "tipo": "Passiva de Arquétipo"}, #
            ...
            "Quebra-Montanhas": {
                "habilidades": [
                    {"nivel_req": 1, "nome": "Golpe Destruidor", "descricao": "Com arma pesada (2 mãos), ignora 1 RD do alvo.", "tipo": "Passiva de Arquétipo"}, #
                    ...
                    {"nivel_req": 1, "nome": "Rompante Poderoso", "descricao": "(Ação Mov.) Move desloc., Vantagem em FOR (Atletismo) para derrubar portão/parede. Se terminar adj. a hostil, ataque corpo a corpo ação livre.", "custo": "N/A", "acao": "Ação de Movimento", "tipo": "Habilidade de Arquétipo", "grupo_escolha": "quebra_montanhas_lvl1", "limite_escolha": 2}, #
    ...
    "Sentinela": {
        "atributo_chave_pm_base": "Sabedoria", # Para PMs base
        "pv_inicial": "8 + CON", "pv_por_nivel": "4 + CON", #
        ...
        "base": [
            {"nivel_req": 1, "nome": "Sentidos Aguçados", "descricao": "Treinado em Percepção e Iniciativa. Vantagem em Percepção para notar perigos escondidos.", "tipo": "Passiva de Classe"}, #
        ...
        "subclasses": {
            "Rastreador dos Ermos": { # Atributo Chave Habilidades: SAB (implícito, pois não muda da base)
                "habilidades": [
                    {"nivel_req": 1, "nome": "Passo Leve na Mata", "descricao": "Ignora penalidades desloc. por terreno difícil natural. Treinado em Sobrevivência.", "tipo": "Passiva de Arquétipo"}, #
                    ...
                    {"nivel_req": 1, "nome": "Disparo Preciso", "descricao": "(Ação) Com ataque à distância (arma), gaste 1 PM antes de rolar. Se acertar, dano +1d4, alvo TR FOR (CD Normal) ou desloc. -3m até fim próx. turno.", "custo": "1 PM", "acao": "Ação Padrão (modifica ataque)", "tipo": "Habilidade de Arquétipo", "grupo_escolha": "rastreador_lvl1", "limite_escolha": 2}, #
            ...
            "Lâmina do Crepúsculo": { # Atributo Chave Habilidades: Destreza
                "habilidades": [
                    {"nivel_req": 1, "nome": "Dança das Sombras", "descricao": "Em penumbra/escuridão, desloc. +1,5m. Treinado em Furtividade.", "tipo": "Passiva de Arquétipo"}, #
                    {"nivel_req": 1, "nome": "Golpe Desorientador", "descricao": "(Ação) Ao acertar ataque corpo a corpo (arma DES), alvo TR SAB (CD Normal) ou desvantagem no próx. ataque.", "custo": "1 PM", "acao": "Ação Padrão (modifica ataque)", "tipo": "Habilidade de Arquétipo", "grupo_escolha": "lamina_crepusculo_lvl1", "limite_escolha": 2}, #
                    ...
                    {"nivel_req": 1, "nome": "Ataque Furtivo", "descricao": "(Ação Bônus) Gaste 1 PM para aumentar dado de dano em 1d4, se não estiver na visão do alvo.", "custo": "1 PM", "acao": "Ação Bônus (modifica ataque)", "tipo": "Habilidade de Arquétipo", "grupo_escolha": "lamina_crepusculo_lvl1", "limite_escolha": 2}, #
            ...
            "Olho Vigilante": { # Atributo Chave Habilidades: Inteligência
                "habilidades": [
                    {"nivel_req": 1, "nome": "Análise Tática", "descricao": "Treinado em Investigação. Pode usar INT para Iniciativa.", "tipo": "Passiva de Arquétipo"}, #
                    ...
                    {"nivel_req": 1, "nome": "Ponto Fraco", "descricao": "(Ação Bônus) Gaste 1 PM, alvo atingido tem desvantagem no próx. TR CON.", "custo": "1 PM", "acao": "Ação Bônus", "tipo": "Habilidade de Arquétipo", "grupo_escolha": "olho_vigilante_lvl1", "limite_escolha": 2}, #
    ...
    "Elo": {
        ...
        "base": [
            {"nivel_req": 1, "nome": "Presença Inspiradora", "descricao": "Treinado em Diplomacia. Aliados a 3m (que veem/ouvem) +1 TR vs medo.", "tipo": "Passiva de Classe"}, #
        ...
        "subclasses": {
            "Voz da Harmonia": {
                "habilidades": [
                    {"nivel_req": 1, "nome": "Aura Pacificadora", "descricao": "Hostis adj. (que não sofreram hostilidade sua) desvantagem na 1ª jogada de ataque no turno.", "tipo": "Passiva de Arquétipo"}, #
            ...
            "Porta-Voz da Chama": {
                "habilidades": [
                    {"nivel_req": 1, "nome": "Foco na Performance", "descricao": "Treinado em Atuação. Pode usar Atuação no lugar de Diplomacia (inspirar/acalmar multidão) ou Intimidação (incitar grupo com discurso).", "tipo": "Passiva de Arquétipo"}, #
            ...
            "Guardião do Coração": {
                "habilidades": [
                    {"nivel_req": 1, "nome": "Escudo Empático", "descricao": "Treinado em Cura. Você e aliados a 1,5m +1 TR Vontade vs medo/desespero.", "tipo": "Passiva de Arquétipo"}, #
...
if __name__ == '__main__':
    ...
    for classe_nome, classe_data in ABILITIES_DATA.items():
        print(f"CLASSE: {classe_nome}")
        print(f"  Atributo Chave PM Base: {classe_data.get('atributo_chave_pm_base', 'N/A')}")
        print(f"  PV Inicial: {classe_data.get('pv_inicial', 'N/A')}")
        print(f"  PM Inicial Multiplicador: {classe_data.get('pm_inicial_multiplicador', 'N/A') if classe_data.get('atributo_chave_pm_base') else 'N/A (Usa Vigor)'}")
        print(f"  Vigor Inicial: {classe_data.get('vigor_inicial', 'N/A')}")
        
        if "base" in classe_data:
            print("  Habilidades Base (Nível 1):")
            for hab in classe_data["base"]:
                if hab.get("nivel_req") == 1:
                    print(f"    - {hab.get('nome')}: {hab.get('descricao')[:50]}... (Custo: {hab.get('custo', 'Passiva')})")
        
        if "subclasses" in classe_data:
            print("  Subclasses (Nível 1 - Exemplos de Habilidades):")
            for sub_nome, sub_data in classe_data["subclasses"].items():
                print(f"    Subclasse: {sub_nome}")
                if "habilidades" in sub_data:
                    for hab_sub in sub_data["habilidades"]:
                        if hab_sub.get("nivel_req") == 1:
                             print(f"      - {hab_sub.get('nome')}: {hab_sub.get('descricao')[:40]}... (Custo: {hab_sub.get('custo', 'Passiva')}, Grupo: {hab_sub.get('grupo_escolha', 'N/A')})")
        print("-" * 30)